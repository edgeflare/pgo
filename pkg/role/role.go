...
import (
	...
	"github.com/edgeflare/pgo/pkg/conn"
...
func List(ctx context.Context, conn conn.Conn) ([]Role, error) {
...
func Create(ctx context.Context, conn conn.Conn, role Role) error {
...
func Update(ctx context.Context, conn conn.Conn, role Role) error {
...
func Get(ctx context.Context, conn conn.Conn, roleName string) (*Role, error) {
	var role *Role
...
func Delete(ctx context.Context, conn conn.Conn, roleName string) error {
...
func alterRoleConfigAndPassword(ctx context.Context, conn conn.Conn, role Role) error {
...
func createOrAlterRole(ctx context.Context, conn conn.Conn, role Role, isCreate bool) error {
