...
//
// Example:
// mosquitto_pub -t /example/prefix/devices/c -m '{"name":"kitchen-light"}' // inserts payload into devices table (defaults to public.table_name)
//
// mosquitto_sub -t '/example/prefix/devices/#' //
//
